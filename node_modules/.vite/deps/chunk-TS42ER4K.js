...
var CustomThemeCtx = (0, import_react5.createContext)(darkThemeObj);
...
function useCustomTheme() {
  return (0, import_react5.useContext)(CustomThemeCtx);
}
...
var Skeleton = (props) => {
  return (0, import_jsx_runtime4.jsx)(SkeletonDiv, { color: props.color, style: {
    height: props.height,
...
var Spacer = ({ y }) => {
  return (0, import_jsx_runtime5.jsx)("div", { style: {
    height: spacing[y]
  } });
};
...
}, _client2 = new WeakMap(), _result = new WeakMap(), _queries2 = new WeakMap(), _observers3 = new WeakMap(), _combinedResult = new WeakMap(), _lastCombine = new WeakMap(), _lastResult = new WeakMap(), _combineResult = new WeakSet(), combineResult_fn = function(input, combine2) {
  if (combine2) {
...
var QueryClientProvider = ({
  ...
  return (0, import_jsx_runtime6.jsx)(QueryClientContext.Provider, { value: client, children });
};
...
function createConnectionManager(storage) {
  ...
  const connect = async (wallet, options) => {
    ...
    (_a12 = options == null ? void 0 : options.onConnect) == null ? void 0 : _a12.call(options, connectedWallet);
...
// node_modules/thirdweb/dist/esm/react/core/connectionManager.js
var _connectManager;
function connectionManagerSingleton(storage) {
  if (_connectManager) {
...
// node_modules/thirdweb/dist/esm/react/web/index.js
var connectionManager = connectionManagerSingleton(webLocalStorage);
...
// node_modules/thirdweb/dist/esm/react/core/utils/socialIcons.js
...
//# sourceMappingURL=chunk-TS42ER4K.js.map
